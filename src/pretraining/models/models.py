...
import self_supervised_agrinet.models.blocks as blocks
import self_supervised_agrinet.models.backbone as backbone
...
class BarlowTwinsModel(nn.Module):
    def __init__(self, cfg:dict):
        ...
        self.resnet50 = backbone.Backbone(cfg['data']['input_size'], 
